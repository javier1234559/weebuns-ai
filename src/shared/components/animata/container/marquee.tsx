...
export default function Marquee({
  ...
  return (
    <div
      {...props}
      className={cn(
        "group relative flex size-full p-2 [--duration:10s] [--gap:12px] [gap:var(--gap)]",
        {
          "flex-col": vertical,
          "flex-row": !vertical,
        },
    ...
    >
      ...
      {applyMask && (
        <div
          className={cn(
            "pointer-events-none absolute inset-0 z-10 size-full from-white/50 from-5% via-transparent via-50% to-white/50 to-95% dark:from-gray-800/50 dark:via-transparent dark:to-gray-800/50",
            {
